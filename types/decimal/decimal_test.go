...
var testTable = []*testEnt{
	...
	{0, "", "", "0."},
...
func init() {
	...
	withNeg := testTable[:]
	for _, s := range testTable {
		if s.float > 0 && s.short != "0" && s.short != "" && s.exact != "0" {
...
func TestNewFromFloat(t *testing.T) {
	for _, x := range testTable {
		...
		if d.String() != s {
			t.Errorf("expected %s, got %s (float: %v)", s, d.String(), x.float)
		}
	}
...
func TestNewFromFloatRandom(t *testing.T) {
	...
	for {
		...
		got := NewFromFloat(in)
		if !want.Equal(got) {
			t.Errorf("in: %v, expected %s, got %s", in, want.String(), got.String())
		}
	}
}
...
func TestJSON(t *testing.T) {
	for _, x := range testTable {
		...
		if err != nil {
			...
			t.Errorf("expected %s, got %s", s, doc.Amount.String())
		}
...
func TestUnmarshalJSONNull(t *testing.T) {
	...
	if err != nil {
		...
		t.Errorf("expected Zero, got %s", doc.Amount.String())
	}
}
...
func TestAAA(t *testing.T) {
	...
	err := json.Unmarshal([]byte(`{"amount":""}`), &doc)
	if err != nil {
		t.Errorf("expected error, got %+v", doc)
	}
}
	...
	for _, x := range testTable {
		...
		if err != nil {
			...
			if doc.Amount.Decimal.String() != s {
				t.Errorf("expected %s, got %s", s, doc.Amount.Decimal.String())
			}
		}
